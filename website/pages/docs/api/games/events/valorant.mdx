...
```json
{"info":{"match_info":{"scoreboard_0":"{\"player_id\":\"11909ad6-77c8-5f70-06234a1eb22a\",\"name\":\"jaxxx #7934\",\"character\":\"\",\"teammate\":false,\"alive\":true,\"kills\":0,\"deaths\":4,\"assists\":0,\"money\":99999,\"is_local\":true}"}},"feature":"match_info"}
```
...
TX_Hud_Pistol_Revolver_S = Classic
...
**Brimstone:**
  TX_Sarge_MolotovLauncher - Brimstone Molotov
  TX_Sarge_OrbitalStrike - Brimstone Ult

**Breach: **
  TX_Breach_FusionBlast - Breach Blast

**Chamber: **
	TX_Hud_Deadeye_Q_Pistol - Chamber Pistol
	TX_Hud_Deadeye_X_GiantSlayer - Chamber Ult

**Jett: **
	TX_Hud_Wushu_X_Dagger - Jett Ult
**KAY/O: **
	TX_Gren_Icon - Kayo Molotov
  
**Killjoy: **
	TX_KJ_Bees - KJ Nano swarm
	tx_KJ_turret - KJ Turret
  
**Neon: **
  TX_Neon_Ult - Neon Ult
  
**Pheonix: **
	TX_Pheonix_Molotov - Pheonix molotov
	TX_Pheonix_FireWall - Pheonix firewall
  
**Raze: **
  TX_Clay_Boomba - Raze Boombot
	TX_Clay_ClusterBomb - Raze Grenage
	TX_Clay_RocketLauncher - Raze Ult
	TX_Clay_Satchel - Raze Satchel
**Skye: **
  TX_Guide4 - Skye Dog

**Sova: **
  TX_Hunter_ShockArrow - Sova shockdart
	TX_Hunter_BowBlast - Sova ult

**Viper: **
  TX_Pandemic_AcidLauncher - Viper molotov
</details>
